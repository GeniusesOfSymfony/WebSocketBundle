...
final class ClientEventListenerTest extends TestCase
{
    /**
     * @group legacy
     */
    public function testTheListenerRejectsMixedApiArguments(): void
    {
        ...
        $this->expectExceptionMessage(sprintf('Cannot use mixed APIs in %s.', ClientEventListener::class));
     ...
     * @doesNotPerformAssertions
     */
    public function testThereIsNoActionWhenNoLoggerIsSetOnTheClientRejectedEventWithTheClientApi(): void
    {
        ...
        $this->createListener($clientStorage, $authenticationProvider)->onClientRejected($event);
    }
     ...
     * @doesNotPerformAssertions
     */
    public function testThereIsNoActionWhenNoLoggerIsSetOnTheClientRejectedEventWithTheAuthenticationApi(): void
    {
        $event = new ClientRejectedEvent('localhost', null);
        ...
        $this->createListener($tokenStorage, $authenticator)->onClientRejected($event);
    }
     ...
     */
    private function createListener(object $tokenStorage, object $authenticator): ClientEventListener
    {
        return new ClientEventListener($tokenStorage, $authenticator);
    }
}
