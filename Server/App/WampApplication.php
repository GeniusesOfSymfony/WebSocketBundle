...
class WampApplication implements PushableWampServerInterface, LoggerAwareInterface
{
    ...
    public function onOpen(ConnectionInterface $conn)
    {
        ...
        $this->eventDispatcher->dispatch($event, Events::CLIENT_CONNECTED);
    }
    ...
    public function onClose(ConnectionInterface $conn)
    {
        ...
        $this->eventDispatcher->dispatch($event, Events::CLIENT_DISCONNECTED);
    }
    ...
    public function onError(ConnectionInterface $conn, \Exception $e)
    {
        ...
        $this->eventDispatcher->dispatch($event, Events::CLIENT_ERROR);
    }
}
