...
class GosWebSocketExtensionTest extends AbstractExtensionTestCase
{
    ...
    public function testContainerIsLoadedWithRpcConfigured()
    {
        $this->container->setParameter(
            'kernel.bundles',
            [
        ...
        $originRegistryDefinition = $this->container->getDefinition('gos_web_socket.rpc.registry');

        $this->assertCount(
            1,
            $originRegistryDefinition->getMethodCalls(),
            'The RPC handlers should be added to the `gos_web_socket.rpc.registry` service.'
        );
    }

    public function testContainerIsLoadedWithTopicsConfigured()
    {
        $this->container->setParameter(
            'kernel.bundles',
            [
        ...
        $originRegistryDefinition = $this->container->getDefinition('gos_web_socket.topic.registry');

        $this->assertCount(
            1,
            $originRegistryDefinition->getMethodCalls(),
            'The Topic handlers should be added to the `gos_web_socket.topic.registry` service.'
        );
    }

    public function testContainerIsLoadedWithPeriodicConfigured()
    {
        $this->container->setParameter(
            'kernel.bundles',
            [
        ...
        $originRegistryDefinition = $this->container->getDefinition('gos_web_socket.periodic.registry');

        $this->assertCount(
            1,
            $originRegistryDefinition->getMethodCalls(),
            'The periodic handlers should be added to the `gos_web_socket.periodic.registry` service.'
        );
    }

    public function testContainerIsLoadedWithServersConfigured()
    {
        $this->container->setParameter(
            'kernel.bundles',
            [
        ...
        $originRegistryDefinition = $this->container->getDefinition('gos_web_socket.server.registry');

        $this->assertCount(
            1,
            $originRegistryDefinition->getMethodCalls(),
            'The servers should be added to the `gos_web_socket.server.registry` service.'
        );
    }
